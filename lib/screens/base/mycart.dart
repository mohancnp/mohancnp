...
//                height: 47, width: 245,
                height: screenwidth*0.114, width: screenwidth*0.5961,
                decoration: BoxDecoration(
                  color: Color(0xff550E1C),
                  borderRadius: BorderRadius.all(Radius.circular(10)),
                  boxShadow: [BoxShadow(color: Color(0xffC3916A).withOpacity(0.5),
                  blurRadius: 30,offset: Offset(0,9))]
                ),
                child: Center(
                  child: Text("Proceed to Checkout",style: getpoppins(TextStyle(
            ...
            child: Column(
              ...
              children: [
                AnimatedContainer(
                  margin: EdgeInsets.only(
//                      top: 16, bottom: 18
                      top: screenwidth*0.0389, bottom: screenwidth*0.0437
                  ),
