  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        width: screenwidth,
        child:
        ScaleTransition(scale: _downscaleanimation,
        child:
        Column(
...
Container(
 ...
 //     bottom:11,left: 5
  bottom: screenwidth*0.02676,left: screenwidth*0.01216
  ),
  child: Image.asset("assets/images/steam.png",width: screenwidth*0.105,),
)),
            ScaleTransition(scale: _imagescaleanimation,
          child:
          Container(
      ...
      //  width: screenwidth*0.282,
        ...
        ScaleTransition(scale: _textscaleanimation,
          child:
            Container(
              margin: EdgeInsets.only(
          //        top: 24
  ...
  deployanimation(){
_imagescaleanimationcontroller = AnimationController(vsync: this, duration: Duration(milliseconds: 750),);
_textscaleanimationcontroller=AnimationController(vsync: this,duration: Duration(milliseconds: 750),);
_fadeanimationcontroller=AnimationController(vsync: this,duration: Duration(milliseconds: initialfadeduration),);
_downscaleanimationcontroller= AnimationController(vsync: this,duration: Duration(milliseconds: 750),);
_downscaleanimation= Tween<double>(begin: 1.0, end: 0).animate(
    CurvedAnimation(parent: _downscaleanimationcontroller, curve: Curves.easeIn));
_imagescaleanimation = Tween<double>(begin: 1.0, end: 1.75).animate(
        CurvedAnimation(parent: _textscaleanimationcontroller, curve: Curves.easeOut));

    _textscaleanimation = Tween<double>(begin: 0, end: 1).animate(
        CurvedAnimation(parent: _imagescaleanimationcontroller, curve: Curves.easeOut));
