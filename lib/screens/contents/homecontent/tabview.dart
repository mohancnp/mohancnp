            ...
            Row(
              ...
              children: [
                GestureDetector(
                    ...
                    child:
                    Container(
                      child: Text("Drinks",style:
                      hometabcontroller.currentpageindex==0?
                      GoogleFonts.poppins(
                        fontWeight: FontWeight.w500,
                          color:hometabcontroller.currentpageindex==0?
                          Colors.white:Colors.white70,
                          fontSize: hometabcontroller.currentpageindex==0?
                 //         16.5:14.5
                   screenwidth*0.0401:screenwidth*0.0352
                      ):  GoogleFonts.poppins(
                ...
                GestureDetector(
                    ...
                    child:
                    Container(
                      child: Text("Bakery",style:
                      hometabcontroller.currentpageindex==1?
                      GoogleFonts.poppins(
                          fontWeight: FontWeight.w500,
                          color:hometabcontroller.currentpageindex==1?
                          Colors.white:Colors.white70,
                          fontSize: hometabcontroller.currentpageindex==1?
                  //        16.5:14.5
                          screenwidth*0.0401:screenwidth*0.0352
                      ):  GoogleFonts.poppins(
                          fontWeight: FontWeight.w300,
                ...
                GestureDetector(
                    ...
                    Container(
                      child: Text("Snacks",style: TextStyle(
                          fontFamily:hometabcontroller.currentpageindex==2?
                          poppinsmedium: poppinslight,
                          color: hometabcontroller.currentpageindex==2?
                          Colors.white:Colors.white70,
                          fontSize: hometabcontroller.currentpageindex==2?
                  //        16.5:14.5
                          screenwidth*0.0401:screenwidth*0.0352
                      ),),
                    )),
                GestureDetector(
                    ...
                    child:
                    Container(
                      child: Text("All Menu",style: TextStyle(
                          fontFamily:hometabcontroller.currentpageindex==3?
                          poppinsmedium:poppinslight,
                          color: hometabcontroller.currentpageindex==3?
                          Colors.white:Colors.white70,
                          fontSize:hometabcontroller.currentpageindex==3?
                  //        16.5: 14.5
                          screenwidth*0.0401:screenwidth*0.0352
                      ),),
                    )),
         ...
         //       bottom: 48
           bottom: screenwidth*0.1167
            ...
            child: AnimatedContainer(
              duration: Duration(milliseconds: 250),
              height: 2,
              width:  hometabcontroller.currentpageindex==1?59:
              hometabcontroller.currentpageindex==3?
         //     69:
           screenwidth*0.167:
              hometabcontroller.currentpageindex==2?
        //      59: 49,
          screenwidth*0.143:screenwidth*0.11922,
