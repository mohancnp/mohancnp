...
class OrderSuccesfulDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: ()async{
       throw Navigator.pushNamedAndRemoveUntil(context, "/Base",
              (route) => false);},
      child: Container(
        width: screenwidth*0.803,
        padding: EdgeInsets.symmetric(
//          horizontal: 22,vertical: 36
            horizontal: screenwidth*0.0535,vertical: screenwidth*0.096
        ),
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                Container(
                  child: Image.asset("assets/images/ordersuccesful/Order Confirmed_Two Color@3x.png",
                  width: 155,),
                ),
              ],
            ),
...
//            height: 42,width: 205,
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [BoxShadow(color: Color(0xffC3916A).withOpacity(0.2),
