...
class UserPreferenceController extends GetxController {
  ...
  Widget preferenceoptions(BuildContext context, orders) {
...
//              height: 40, width: 200,
              ...
              decoration: BoxDecoration(
                  boxShadow: [
                    BoxShadow(
                        color: Color(0xC3916A4D).withOpacity(0.2),
                        offset: Offset(0, 9),
                        blurRadius: 30)
                  ],
                  color: preferencechoice == collection
                      ? Color(0xffD4874C)
                      : Colors.white,
              ...
              child: GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                      ...
                      color: preferencechoice == delivery
                          ? Color(0xffD4874C)
                          : Colors.white,
                      borderRadius: BorderRadius.all(Radius.circular(25)),
                      border: Border.all(
