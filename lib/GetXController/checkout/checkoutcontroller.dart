          ...
          Row(
            ...
            children: [
              ...
              //      left: 6
                ...
                child: Text("Delivery Location",style: getpoppins(
                  TextStyle(
             ...
             //       fontSize:14.5
              ...
              //          right: 4
                right: screenwidth*0.00973),
                    child: Text("Add",style: getpoppins(
                        TextStyle(
                            fontWeight: FontWeight.w500,
                            color: coffeecolor,
                     //       fontSize:12.5
...
//                vertical: 10,horizontal: 12
                vertical: screenwidth*0.0243,horizontal: screenwidth*0.0291
            ),
            width: screenwidth,
...
//                              fontSize:13.5
                    ...
                    Container(
                      child: Text("Park In, United Kingdom",style: getpoppins(
                          TextStyle(
                              fontWeight: FontWeight.w400,
...
//                              fontSize:10.5
                    ...
                    Container(
                      child: Text("+99 56581464",style: getpoppins(
                          TextStyle(
                              fontWeight: FontWeight.w400,
                              color: darkgrey.withOpacity(0.8),
                   //           fontSize:10.5
            ...
            children: [
              Container(
                margin: EdgeInsets.only(
                  //      left: 6
                    left: screenwidth*0.0145),
                child: Text("Delivery Time",style: getpoppins(
                    TextStyle(
                        fontWeight: FontWeight.w500,
                        color: darkgrey,
                        //       fontSize:14.5
                ...
                Column(
                    ...
                    children:[
                      Row(
                        ...
                        children: [
                          Container(
                            child: Text("Enter Time",style: getpoppins(
                                TextStyle(
                                    fontWeight: FontWeight.w400,
                                    color: darkgrey,
//                              fontSize:13.5
                      ...
                      Divider(color: darkgrey.withOpacity(0.15),
                      thickness: 1.5,),
                      Container(
                      ...
                      ListView.builder(
                        itemCount: 4,
                          ...
                          itemBuilder: (context,index){
                            return timecontainer(context,index, gettimetext(index));
                      }))
...
//          horizontal: 17.5
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
            color: selectedtimeindex==index?Colors.transparent:coffeecolor
            ,width: 1.25)
      ),
      child:Center(
        child: Text(timetext,style: getpoppins(
          TextStyle(
   ...
   //       bottom: 24
     bottom: screenwidth*0.0583 ),
      child: Column(
        ...
        children: [
          Container(
            child: Text("How would you like to receive your order confirmation?",
         ...
         //       top: 11
           top: screenwidth*0.0267 ),
            ...
            child:
                AnimatedContainer(
//                  height: 26,width: 78,
                  height: screenwidth*0.0632,width: screenwidth*0.1897,
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                      color:
                      selectedorderconfirmationtype=='email'?Colors.transparent:coffeecolor,
...
//                  height: 26,width: 78,
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            color:
                            selectedorderconfirmationtype=='text'?Colors.transparent:coffeecolor,
//                  width: 1.25
                            width: screenwidth*0.00304
                        ),
                      ),
...
//                        fontSize: 10.5,
  ...
  Widget orderinstruction(BuildContext context){
    ...
    margin: EdgeInsets.only(
//          bottom: 35
          bottom: screenwidth*0.0851,left:  screenwidth * 0.0535,right:  screenwidth * 0.0535
      ),
      padding: EdgeInsets.symmetric(
//          horizontal: 26
