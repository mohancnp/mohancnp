...
//                      top: 16, bottom: 18
      ...
      width: screenwidth,
      alignment:
          currenttabindex == 0 ? Alignment.centerLeft : Alignment.centerRight,
...
//                  vertical: 14.5,horizontal: 15
                  vertical: screenwidth*0.0352,horizontal: screenwidth*0.0364
              ),
              duration: Duration(milliseconds: 250),
              width: screenwidth,
              decoration: BoxDecoration(
                boxShadow: [BoxShadow(color: toppingsexpandableController.expanded?
              ...
              child: Row(
                ...
                children: [
                  Container(
                    child: Text("Toppings",style: getpoppins(
                        TextStyle(
                  ...
                  Container(
                      child: Row(
                          children:[Text(currenttopping,style: getpoppins(
                              TextStyle(
                                  fontWeight: FontWeight.w500,
                                  color: coffeecolor,
                       //           fontSize: 12.5
                           ...
                           //       left: 12
                             left: screenwidth*0.0291 ),
                              child: Icon(
                                ...
                                FeatherIcons.chevronUp: FeatherIcons.chevronDown,
                                color: coffeecolor,
                       //         size: 17,
      ...
      expanded: Container(
        ...
        padding: EdgeInsets.symmetric(
    //      vertical: 14.5,horizontal: 15
      vertical: screenwidth*0.03527,horizontal: screenwidth*0.0364
        ),
        width: screenwidth,
        decoration: BoxDecoration(
          color: Colors.white,
      //    boxShadow: [BoxShadow(color: Colors.black12,
        ...
        child:
            Container(
              child: Text("Caramel Syrup",style: getpoppins(
                  TextStyle(
                      fontWeight: FontWeight.w500,
                      color: currenttopping=="Caramel Syrup"?
                      coffeecolor:darkgrey,
             //         fontSize: 12.5
        ...
        GestureDetector(
          ...
          child:
            Container(
              ...
              child: Text("Honey",style: getpoppins(
                  TextStyle(
                      fontWeight: FontWeight.w500,
                      color: currenttopping=="Honey"?
                      coffeecolor:darkgrey,
                      //         fontSize: 12.5
                      fontSize: screenwidth*0.0333   )
              ),),
        ...
        GestureDetector(
          ...
          child: Container(
              margin: EdgeInsets.only(top: 8),
              child: Text("Cinnamon",style: getpoppins(
                  TextStyle(
                      fontWeight: FontWeight.w500,
        ...
        GestureDetector(
          ...
          child:
            Container(
              margin: EdgeInsets.only(top: 8),
              child: Text("Butter",style: getpoppins(
                  TextStyle(
                      fontWeight: FontWeight.w500,
                      color:  currenttopping=="Butter"?
                      coffeecolor:darkgrey,
                      //         fontSize: 12.5
                      fontSize: screenwidth*0.0333   )
              ),),
        ...
        GestureDetector(
          ...
          child: Container(
              margin: EdgeInsets.only(top: 8),
              child: Text("Cardamom",style: getpoppins(
                  TextStyle(
                      fontWeight: FontWeight.w500,
  ...
  Widget milkoptions(BuildContext context){
    ...
    return
      ...
      //        vertical: 14.5,horizontal: 15
          ...
          width: screenwidth,
          decoration: BoxDecoration(
            boxShadow: [BoxShadow(color: milkexpandableController.expanded?
            Colors.black.withOpacity(0.08):Colors.transparent,
                blurRadius: 20,offset: Offset(0,3))],
            color: Color(0xffE8E8E8),
          ...
          child: Row(
            ...
            children: [
              Container(
                child: Text("Milk",style: getpoppins(
                    TextStyle(
                        fontWeight: FontWeight.w500,
                        color: darkgrey,
            //            fontSize: 14.5
              ...
              Container(
                  child: Row(
                      children:[Text(currentmilk,style: getpoppins(
                          TextStyle(
                              fontWeight: FontWeight.w500,
                              color: coffeecolor,
               //               fontSize: 12.5
          ...
          child: Column(
            ...
            children: [
              GestureDetector(
                  ...
                  child:
                  Container(
                    child: Text("Soy Milk",style: getpoppins(
                        TextStyle(
                            fontWeight: FontWeight.w500,
                            color: currentmilk=="Soy Milk"?
                            coffeecolor:darkgrey,
                            //         fontSize: 12.5
                            fontSize: screenwidth*0.0333   )
                    ),),
              ...
              GestureDetector(
               ...
               //         top: 8
                 top: screenwidth*0.01946   ),
                    child: Text("Almond Milk",style: getpoppins(
                        TextStyle(
                            fontWeight: FontWeight.w500,
              ...
              GestureDetector(
                  ...
                  child: Container(
                    margin: EdgeInsets.only(top: 8),
                    child: Text("Rice Milk",style: getpoppins(
                        TextStyle(
                            fontWeight: FontWeight.w500,
                            color:  currentmilk=="Rice Milk"?
                            coffeecolor:darkgrey,
                            //         fontSize: 12.5
                            fontSize: screenwidth*0.0333   )
                    ),),
              ...
              //          top: 8
                top: screenwidth*0.01946
                    ...
                    child: Text("Coconut Milk",style: getpoppins(
                        TextStyle(
                            fontWeight: FontWeight.w500,
            ...
            //            top: 8
                    ...
                    child: Text("Skim Milk",style: getpoppins(
                        TextStyle(
                            fontWeight: FontWeight.w500,
                            color: currentmilk=="Skim Milk"?
                            coffeecolor:darkgrey,
                            //         fontSize: 12.5
                            fontSize: screenwidth*0.0333   )
                    ),),
          ...
          Row(
            ...
            children: [
              Container(
                ...
                child: Text("Add Extra",style: getpoppins(
                  TextStyle(
                    fontWeight: FontWeight.w500,
                    color: darkgrey,
          //          fontSize: 14.5
...
//                        height: 94,width: 134,
                        height: screenwidth*0.2287,width: screenwidth*0.326,
                        child:
                      Stack(
                    children:[
                      Positioned(
                 ...
                 //         bottom:24,
                  ...
                  //          left: 12,bottom: 4,right: 4
                   left:  screenwidth*0.0291,bottom: screenwidth*0.00973,right:screenwidth*0.00973
                        ),
//                      height: 88,width: 110,
                        height: screenwidth*0.2141,width: screenwidth*0.267,
                        decoration: BoxDecoration(
                        color: Colors.white,
                        borderRadius: BorderRadius.all(Radius.circular(9)),
                        boxShadow: [BoxShadow(color: Colors.black12,
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              child: Text(gettitleforextras(index),style: getpoppins(
                                  TextStyle(
                        ...
                        //              fontSize: 12
                          fontSize:  screenwidth*0.0291        )
                            ...
                            Row(
                              ...
                              children: [
                                Container(
                                  child: Text("\$1.50",style: getpoppins(
                                      TextStyle(
                                          fontWeight: FontWeight.w500,
                                          color: darkgrey,
                             //             fontSize: 13.5
                      ...
                      Positioned(
                        ...
                        right: 0,
                        child: Image.asset(
                          getimageforextrasrow(index),
                          width: index==2?
                  //        74:
                    screenwidth*0.1800:
                          index==1?
              //            68: 86,
                screenwidth*0.1654:screenwidth*0.2092
                        ),
                      )
                    ]));
